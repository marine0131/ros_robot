...
int frame_decode(unsigned char *data_buf)
{
	...
	msg.w = drive_info.W;
        ...
        printf("%d,%d,%d,%d,%d,%d\t\n",drive_info.left_odm,drive_info.right_odm,drive_info.V,drive_info.W,msg.vx,msg.w);
...
int main (int argc, char** argv){
    ...
    ros::NodeHandle nh;
    ros::Subscriber encoder_sub=nh.subscribe("encoder_reset",50,encoderClean);
    ros::Subscriber v_sub = nh.subscribe("smoother_cmd_vel", 50, v_callback);
