...
int main (int argc, char** argv){
    ...
    ros::NodeHandle nh;
    ros::Subscriber encoder_sub=nh.subscribe("motor_encoderClean",1000,encoderClean);
    ros::Subscriber v_sub = nh.subscribe("car_speed", 1000, v_callback);
    ros::Publisher sensor_pub = nh.advertise<xunjian_nav::Sensor>("sensor_msgs", 1000);
    ros::Publisher range_pub=nh.advertise<xunjian_nav::Ultrasound>("range",1000);
