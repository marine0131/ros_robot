...
(cl:defmethod ultra_1-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_1-val is deprecated.  Use xunjian_nav-msg:ultra_1 instead.")
  (ultra_1 m))

(cl:ensure-generic-function 'ultra_2-val :lambda-list '(m))
(cl:defmethod ultra_2-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_2-val is deprecated.  Use xunjian_nav-msg:ultra_2 instead.")
  (ultra_2 m))

(cl:ensure-generic-function 'ultra_3-val :lambda-list '(m))
(cl:defmethod ultra_3-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_3-val is deprecated.  Use xunjian_nav-msg:ultra_3 instead.")
  (ultra_3 m))

(cl:ensure-generic-function 'ultra_4-val :lambda-list '(m))
(cl:defmethod ultra_4-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_4-val is deprecated.  Use xunjian_nav-msg:ultra_4 instead.")
  (ultra_4 m))

(cl:ensure-generic-function 'ultra_5-val :lambda-list '(m))
(cl:defmethod ultra_5-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_5-val is deprecated.  Use xunjian_nav-msg:ultra_5 instead.")
  (ultra_5 m))

(cl:ensure-generic-function 'ultra_6-val :lambda-list '(m))
(cl:defmethod ultra_6-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:ultra_6-val is deprecated.  Use xunjian_nav-msg:ultra_6 instead.")
  (ultra_6 m))
