...
(cl:defclass <GridLaser> (roslisp-msg-protocol:ros-message)
  ((gridPnt
    :reader gridPnt
    :initarg :gridPnt
    :type (cl:vector xunjian_nav-msg:GridPoint)
   :initform (cl:make-array 0 :element-type 'xunjian_nav-msg:GridPoint :initial-element (cl:make-instance 'xunjian_nav-msg:GridPoint)))
   (mapGridWidth
    :reader mapGridWidth
...
(cl:defmethod cl:initialize-instance :after ((m <GridLaser>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridLaser)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xunjian_nav-msg:<GridLaser> is deprecated: use xunjian_nav-msg:GridLaser instead.")))

(cl:ensure-generic-function 'gridPnt-val :lambda-list '(m))
(cl:defmethod gridPnt-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:gridPnt-val is deprecated.  Use xunjian_nav-msg:gridPnt instead.")
  (gridPnt m))

(cl:ensure-generic-function 'mapGridWidth-val :lambda-list '(m))
(cl:defmethod mapGridWidth-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:mapGridWidth-val is deprecated.  Use xunjian_nav-msg:mapGridWidth instead.")
  (mapGridWidth m))

(cl:ensure-generic-function 'mapGridHeight-val :lambda-list '(m))
(cl:defmethod mapGridHeight-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:mapGridHeight-val is deprecated.  Use xunjian_nav-msg:mapGridHeight instead.")
  (mapGridHeight m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GridLaser>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'gridPnt)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'xunjian_nav-msg:GridPoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GridLaser>)))
  ...
  (cl:format cl:nil "GridPoint[] gridPnt~%int32 mapGridWidth~%int32 mapGridHeight~%~%================================================================================~%MSG: xunjian_nav/GridPoint~%int32 x~%int32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GridLaser)))
  "Returns full string definition for message of type 'GridLaser"
  (cl:format cl:nil "GridPoint[] gridPnt~%int32 mapGridWidth~%int32 mapGridHeight~%~%================================================================================~%MSG: xunjian_nav/GridPoint~%int32 x~%int32 y~%~%~%"))
