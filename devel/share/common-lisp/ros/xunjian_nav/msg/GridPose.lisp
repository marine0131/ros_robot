...
(cl:defmethod cl:initialize-instance :after ((m <GridPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xunjian_nav-msg:<GridPose> is deprecated: use xunjian_nav-msg:GridPose instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <GridPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:angle-val is deprecated.  Use xunjian_nav-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'grid_x-val :lambda-list '(m))
(cl:defmethod grid_x-val ((m <GridPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:grid_x-val is deprecated.  Use xunjian_nav-msg:grid_x instead.")
  (grid_x m))

(cl:ensure-generic-function 'grid_y-val :lambda-list '(m))
(cl:defmethod grid_y-val ((m <GridPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xunjian_nav-msg:grid_y-val is deprecated.  Use xunjian_nav-msg:grid_y instead.")
  (grid_y m))
