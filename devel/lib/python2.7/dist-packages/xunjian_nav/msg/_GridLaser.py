...
"""autogenerated by genpy from xunjian_nav/GridLaser.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import xunjian_nav.msg

class GridLaser(genpy.Message):
  _md5sum = "0e45ff288b41dffb248ecb1dbf9881bc"
  _type = "xunjian_nav/GridLaser"
...
"""
  ...
  _slot_types = ['xunjian_nav/GridPoint[]','int32','int32']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = xunjian_nav.msg.GridPoint()
        _x = val1
        start = end
        end += 8
